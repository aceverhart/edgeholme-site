...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // — Newsletter / Notify Me forms → Contact tab
  ...
  // — Trade application form → Trade Customer tab
  ...
  // — Founding trade form → Founding Trade Member tab
  document.querySelectorAll('.js-founding-form').forEach(form => {
    form.addEventListener('submit', (e) => {
      e.preventDefault();
  ...
  // — Contact page forms → Contact tab
  document.querySelectorAll('.js-contact-form').forEach(form => {
    form.addEventListener('submit', (e) => {
      ...
      const data = { formType: 'contact', source: 'contact-page' };
      new FormData(form).forEach((val, key) => { data[key] = val; });
      ...
      fetch(SCRIPT_URL, {
        ...
        form.querySelectorAll('.form-input, .form-textarea').forEach(f => f.value = '');
        if (success) success.style.display = 'block';
